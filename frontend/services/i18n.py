...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "chapter_viewer.regenerate_button": "Regenerate chapter explanations",
        "chapter_viewer.regenerate_running": "Rebuilding chapter narratives...",
        "chapter_viewer.regenerate_success": "Chapter explanations updated.",
        "chapter_viewer.regenerate_error": "Failed to regenerate chapter explanations: {error}",
    ...
    "ja": {
        ...
        "chapter_viewer.regenerate_button": "章の説明を再生成",
        "chapter_viewer.regenerate_running": "章のナラティブを再構築しています...",
        "chapter_viewer.regenerate_success": "章の説明を更新しました。",
        "chapter_viewer.regenerate_error": "章の説明の再生成に失敗しました: {error}",
